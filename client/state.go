...
func (c *WASMClient) ExecuteStateTransaction(ctx context.Context, storeName string, meta map[string]string, ops []*StateOperation) error {
	if storeName == "" {
...
func (c *WASMClient) SaveState(ctx context.Context, storeName, key string, data []byte, so ...StateOption) error {
...
func (c *WASMClient) SaveBulkState(ctx context.Context, storeName string, items ...*SetStateItem) error {
	if storeName == "" {
...
func (c *WASMClient) GetBulkState(ctx context.Context, storeName string, keys []string, meta map[string]string, parallelism int32) ([]*BulkStateItem, error) {
	if storeName == "" {
...
func (c *WASMClient) GetState(ctx context.Context, storeName, key string) (item *StateItem, err error) {
...
func (c *WASMClient) GetStateWithConsistency(ctx context.Context, storeName, key string, meta map[string]string, sc StateConsistency) (*StateItem, error) {
...
func (c *WASMClient) DeleteState(ctx context.Context, storeName, key string) error {
...
func (c *WASMClient) DeleteStateWithETag(ctx context.Context, storeName, key string, etag *ETag, meta map[string]string, opts *StateOptions) error {
	if err := hasRequiredStateArgs(storeName, key); err != nil {
...
func (c *WASMClient) DeleteBulkState(ctx context.Context, storeName string, keys []string) error {
	if len(keys) == 0 {
		return nil
	}
...
// DeleteBulkState deletes content for multiple keys from store.
func (c *WASMClient) DeleteBulkStateItems(ctx context.Context, storeName string, items []*DeleteStateItem) error {
	if len(items) == 0 {
		return nil
	}
